...
public class EjecutorDeTareasTest {
	 Ubicacion buenosAires;
	    ...
	    public void setup(){
	        ...
	        remera1 = new Prenda(remera, "RemeraDePandas", blancoYNegro, Material.LINO,Estilo.DEPORTIVO);
	        remera2 = new Prenda(top, "Top", blancoYNegro, Material.LINO, Estilo.DEPORTIVO);
	        pantalon1 = new Prenda(pantalon, "Pantalon1", azul, Material.LINO, Estilo.DEPORTIVO);
	        pantalon2 = new Prenda(pantalonCorto, "PantalonCorto", amarillo, Material.LINO,Estilo.DEPORTIVO);
	        zapatillas1 = new Prenda(zapatillas, "Zapatillas1", rojoYVerde, Material.LINO,Estilo.DEPORTIVO);
	        ...
	        accesorio3 = new Prenda(paraguas, "Paraguas", amarillo, Material.PLASTICO);
	        accesorio4 = new Prenda(lentes, "Lentes", amarillo, Material.PLASTICO);
