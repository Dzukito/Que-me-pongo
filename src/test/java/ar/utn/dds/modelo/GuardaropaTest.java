...
public class GuardaropaTest {
    ...
    TipoPrenda pantalon, remera, zapatillas, accesorio, top, calzon,bufanda, zapatos, pantalonCorto;
...
/*
        ...
        ropero1 = new Guardaropa(prendas);
