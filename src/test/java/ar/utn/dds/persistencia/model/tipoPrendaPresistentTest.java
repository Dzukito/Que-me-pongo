...
public class tipoPrendaPresistentTest extends AbstractPersistenceTest implements WithGlobalEntityManager {
    ...
    public void recuperandoTipoDePrendaUno(){
        TipoPrenda tipoPrenda = (TipoPrenda) EntityManagerHelper.createQuery("from tipoPrenda where id_tipoPrenda = '1'").getResultList().get(0);
        Assert.assertEquals(Categoria.TORSO, tipoPrenda.categoria());
